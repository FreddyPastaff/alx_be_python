...
CELSIUS_TO_FAHRENHEIT_CONVERSION_FACTOR = 9 / 5
...
if unit == "F":
    ...
    print(f"Conversion factor used: {FAHRENHEIT_TO_CELSIUS_CONVERSION_FACTOR:.2f}")

elif unit == "C":
    converted = convert_to_fahrenheit(temperature)
    print(f"\nTemperature in Celsius: {temperature}")
    print(f"Temperature in Fahrenheit: {converted:.2f}")
    print(f"Conversion factor used: {CELSIUS_TO_FAHRENHEIT_CONVERSION_FACTOR:.2f}")
